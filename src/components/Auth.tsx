    ...
    <div className="min-h-screen flex items-center justify-center bg-gunmetal p-4">
      ...
      >
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold tracking-tight text-chartreuse">{t('appName')}</h1>
          <p className="text-white/60 mt-2">{t('auth.tagline')}</p>
        </div>
        ...
        <AnimatePresence mode="wait">
          {step === 'email' ? (
            ...
            >
              <div>
                <label className="block text-sm font-medium text-white/80 mb-1">{t('auth.otpLabel')}</label>
                <input
                  type="text"
                  required
                  value={code}
